...
for c=1:N_number_COM
    for cc=1:N_number_Tilt
        ...
        if heattime~=0
            [tm,psi_t]=ode113(@(t,psi) MS_gate_COM_fun(t,psi,qudit_level,gate_time,n_cycle,eta_COM,w_COM,Omega_bar,...
                State_raise,State_lower,State_I,Motion_raise_COM,Motion_lower_COM,...
                Motion_I_Tilt),[0 heattime*gate_time],psi,options); %Evaluate Schrodinger's differential equation
            tm1=tm;
            psi_t1=psi_t;
            psi=psi_t(end,:);
            psi=psi.';
        ...
        [tm,psi_t]=ode113(@(t,psi) MS_gate_COM_fun(t,psi,qudit_level,gate_time,n_cycle,eta_COM,w_COM,Omega_bar,...
            State_raise,State_lower,State_I,Motion_raise_COM,Motion_lower_COM,...
            Motion_I_Tilt),[heattime*gate_time gate_time],psi,options); %Evaluate Schrodinger's differential equation
        tm2=tm;
        psi_t2=psi_t;
